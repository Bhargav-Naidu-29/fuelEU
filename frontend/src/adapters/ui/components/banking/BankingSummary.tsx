...
export const BankingSummary: React.FC = () => {
    ...
    const handleRefresh = () => {
        ...
        if (year > 0) {
            ...
            // Reset balance if All Years is selected
            // (Assuming setData is available or useCase handles it)
        }
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {balance && year > 0 ? (
                    ...
                    <div className="p-6 bg-indigo-50 rounded-xl border border-indigo-100 flex items-center justify-center text-center">
                        <div>
                            <p className="text-indigo-900 font-bold text-sm">Aggregated View</p>
                            <p className="text-indigo-600 text-[10px] uppercase font-bold tracking-tight">Select a year for detailed CB</p>
                        </div>
                    </div>
                ) : !balanceLoading && shipId && year > 0 && (
